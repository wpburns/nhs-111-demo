...
# documents = SimpleDirectoryReader("./patient_files").load_data()
# index = GPTVectorStoreIndex.from_documents(documents)
# index.storage_context.persist(persist_dir="patient_db")

try:
    # rebuild storage context
    storage_context = StorageContext.from_defaults(persist_dir="patient_db")
    # load index
